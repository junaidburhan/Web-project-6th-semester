<?php
    ...
    $id = mysqli_real_escape_string($conn,$_POST['id']);
  	$output = "";
	$teachers = mysqli_query($conn,"SELECT * FROM employees INNER JOIN rotba ON employees.rotba_id = rotba.rot_id INNER JOIN degree ON employees.degree_id = degree.deg_id INNER JOIN job ON employees.job_id = job.job_id INNER JOIN faculty ON employees.faculty_id = faculty.fac_id INNER JOIN province ON employees.province_id = province.pro_id WHERE id = $id");
	...
	$output .= "<table><tr><th>آی دی : </th><th> &nbsp;&nbsp;&nbsp; </th><th style='text-transform:uppercase'>ku-".$value['fac_abr']."-".$id1."<tr>".
    ...
    "<tr><th>رتبه علمی : </th><th> &nbsp; </th><th>".$value['rot_name']."</th></tr>".
