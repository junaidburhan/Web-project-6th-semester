   ...
   if(filter_var($email,FILTER_VALIDATE_EMAIL))
   {
      ...
      else
      {
          ...
          if(in_array($img_ext,$extensions))
          {
                ...
                {
                  $query = mysqli_query($conn,"INSERT INTO employees VALUES (null,'$name','$lname','$fname','$ename','$elname','$gender','$email','$phone','$status','$birth_date','$hire_date','$position','$eposition','e','$faculty','$job','$degree','$province',null,'$path')");
                    if($query)
                    {
